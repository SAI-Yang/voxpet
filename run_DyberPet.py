...
from DyberPet.voice_assistant import VoiceAssistant
...
class DyberPetApp(QApplication):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.p.voice_assistant = self.voice
    ...
    def __connectSignalToSlot(self):
        ...
        # Voice Assistant
        self.voice.show_bubble.connect(self.note.setup_bubbleText)
        self.voice.show_notification.connect(self.note.setup_notification)
